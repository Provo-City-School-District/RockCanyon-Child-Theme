<div class="dropDownColumn">
	...
	?>
		<ul>
			...
			<li class="int"><a href="https://rockcanyon.provo.edu/school-information/calendar/">Rock Canyon Calendar</a></li>
			<li class="int"><a href="https://rockcanyon.provo.edu/school-information/district-school-year-calendar/">District Events Calendar</a></li>
	...
	?>
		<ul>
			<li class="int"><a href="https://rockcanyon.provo.edu/study-at-home/">Study At Home</a></li>
			<li class="ext"><a href="https://grades.provo.edu/public/">PowerSchool (Grades & Attendance)</a></li>
			<li class="int"><a href="https://rockcanyon.provo.edu/faculty-staff/teachers-directory/">Classrooms</a></li>
...
<div class="dropDownColumn">
	<?php 
		...
		if(is_page( 'school-information' ) || in_array( 117, get_post_ancestors($post))){
			?>
			<h2><img src="https://rockcanyon.provo.edu/wp-content/themes/pcsd-2019-theme/assets/icons/school-info.svg" alt="" />About Rock Canyon</h2>
			<?php	
		} else {
			?>
			<h3><img src="https://rockcanyon.provo.edu/wp-content/themes/pcsd-2019-theme/assets/icons/school-info.svg" alt="" />About Rock Canyon</h3>
			<?php
		}	
	?>
	
		<ul>
			<li class="int"><a href="https://rockcanyon.provo.edu/school-information/contact-our-school/">Contact Our School</a></li>
            <li class="int"><a href="https://rockcanyon.provo.edu/school-information/school-hours/">Hours of Operation &amp; Daily Schedule</a></li>
